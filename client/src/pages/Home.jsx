...
const Home = () => {
  return (
    <div className='bg-solar bg-cover  bg-no-repeat bg-center  h-[100vh]'>
      <Navbar/>
      <h1 className='text-5xl  m-5 p-2 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-yellow-300'>Rooftop Solar Energy Potential Estimator</h1>
      <h2 className='text-3xl m-5 p-1 italic '> Leverage Satellite Data and AI for Accurate Solar Power Projections</h2>

      <div className="flex justify-center mt-10    items-center">
        <div className='border-2 border-orange-300  p-10 backdrop-blur-sm rounded-3xl'>
...
<hr  className='mt-2'/>
      <h2 className="text-2xl flex justify-center p-1 font-bold text-orange-400">OR</h2>
          </div>
       <Webcam/>
      </div>
    </div>
